...
const say=H.msg(root,"Cada variedade quer <b>umidade + temperatura</b> certas. névoa por prateleira · / temperatura global. No ponto = cresce; colha em 100%!");
...
H.btn(row,"−2°",()=>{if(!over){temp=Math.max(10,temp-2);H.sfx("tick");paint();}},false);
H.loop(dt=>{
  if(over)return;
