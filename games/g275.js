...
const say=H.msg(root,'Saqueie os 4 cômodos e volte à porta ! O ronda circula — se ele entrar com você, esconda-se no armário (fique parado no )!');
...
H.loop(dt=>{
 ...
 for(let r=0;r<2;r++)for(let c=0;c<3;c++){
  ...
  x.fillText('i:cabinet',OX+c*RW+RW-28,OY+r*RH+32);
  if(c===0&&r===1)x.fillText('i:door',OX+c*RW+28,OY+r*RH+RH-16);
  const k=c+','+r;
  if(LOOT.some(l=>l[0]===c&&l[1]===r)&&!GOT[k])x.fillText('i:gem',OX+c*RW+RW/2,OY+r*RH+RH/2+8);
  if(CIRC[guard]===i){x.font='26px system-ui';x.fillText('i:guard',OX+c*RW+RW/2,OY+r*RH+44);}
 }
