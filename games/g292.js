...
const say=H.msg(root,'Equilibre a bike parada com ←→! No verde, faça manobras para pontuar. Caiu 3 vezes = fim. Meta: 600!');
...
H.loop(dt=>{
 ...
 x.font='60px system-ui';x.textAlign='center';x.fillText('i:bike',0,20);x.restore();
 ...
 x.fillText(score+' pts · '+Math.ceil(time)+'s · quedas '+falls+'/3 · meta 600',14,90);
