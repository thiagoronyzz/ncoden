...
const MARKS=[{x:60,y:60,k:''},{x:400,y:80,k:''},{x:80,y:380,k:''},{x:400,y:380,k:''}];
...
H.onTap(o,(px,py)=>{
 ...
 hint=bd<60?'MUITO PERTO!':bd<120?'perto…':bd<200?'longe…':'muito longe…';
...
H.loop(()=>{
 ...
 OAS.forEach(s=>{if(s.got){x.font='34px system-ui';x.fillText('i:palm',s.x,s.y);}});
 ...
 x.fillText('i:palm'+found+'/3 · '+digs+'  '+hint,12,28);
});
}});
