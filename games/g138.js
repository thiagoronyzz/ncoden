...
const say=H.msg(root,"Brinquedo <b>perfeito </b> → EMBALAR · <b>quebrado ♥</b> (torto/cinza) → DESCARTAR. Clique na peça e depois no destino!");
...
H.loop(dt=>{
  ...
  toys.forEach(t=>{
    ...
    x.fillText(t.bad?"":"i:teddy",-15,10);
