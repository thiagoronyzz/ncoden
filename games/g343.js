...
const say=H.msg(root,'Desça com ↓, suba com ↑! Perto da criatura, toque FOTOGRAFAR. 6 espécies diferentes! O₂ acaba = fim.');
...
H.loop(dt=>{
 ...
 SP.forEach(s=>{
  ...
  x.fillText(s.got?'i:check':s.k,s.x+Math.sin(t+s.ph)*20,sy);
 });
 x.font='30px system-ui';x.fillText('i:diver',230,py-cam+10);
