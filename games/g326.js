...
const PATHS=[
 ['Cume exposto (rápido, frio)','Floresta (lento, quente)',()=>{prog+=22;warm-=22;},()=>{prog+=12;warm-=8;}],
 ['Caverna escura (atalho?)','Contornar (seguro)',()=>{if(Math.random()<.6){prog+=25;}else{warm-=20;say('Caverna sem saída! −20 calor.');}prog+=5;},()=>{prog+=12;warm-=10;}],
...
function next(){
 ...
 brow.innerHTML='';
 H.btn(brow,''+e[0],()=>{e[2]();H.sfx('tick');status();next();},false);
...
H.done(win?{win:true,score:sc|0,title:'Abrigo encontrado!',sub:'Quentinho na nevasca!'}:{win:false,score:sc|0,title:'Congelado!',sub:'Faça fogueiras quando o calor baixar!'});}
next();
}});
