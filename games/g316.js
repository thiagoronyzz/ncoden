...
H.loop(dt=>{
 ...
 for(let r=0;r<10;r++)for(let c=0;c<10;c++){
  ...
  x.globalAlpha=1;
  if(v==='G'&&d<=R+1){x.font='22px system-ui';x.textAlign='center';x.fillText('i:gem',OX+c*CS+22,OY+r*CS+32);}
 }
 x.font='22px system-ui';x.textAlign='center';x.fillText('i:door',OX+9*CS+22,OY+3*CS+32);
 ...
 x.fillText('i:flame'+(torch|0)+'% '+gems,12,452);
});
status();
}});
