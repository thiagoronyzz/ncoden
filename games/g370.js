...
function show(){
 ...
 time=15;
 hud.set('r',(round+1)+'/6');
 fc.innerHTML='IMITE:<br><span style="font-size:34px"><b>'+picks[round]+'</b></span><br> 15s';
 brow.innerHTML='';
...
H.every(1000,()=>{
 ...
 fc.innerHTML='IMITE:<br><span style="font-size:34px"><b>'+picks[round]+'</b></span><br> '+time+'s';
});
