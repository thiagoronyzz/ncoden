...
H.done(win?{win:true,score:sc|0,title:'Fora da mina!',sub:'Escapou com '+(o2|0)+'% de O₂.'}:{win:false,score:sc|0,title:'Sem ar!',sub:'Cave em ritmo e poupe oxigênio!'});}
H.loop(dt=>{
 if(over)return;t+=dt;
 o2-=dt*1.6;
 status();
 ...
 x.font='30px system-ui';x.textAlign='center';x.fillText('i:door',430,240);
 x.fillText('i:pick',30+400*Math.min(1,prog/100),220);
