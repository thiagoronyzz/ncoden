...
H.done(win?{win:true,score:sc|0,title:'Estação salva!',sub:'6 vazamentos selados!'}:{win:false,score:sc|0,title:'Sem oxigênio!',sub:fixed+'/6 reparos. Seja rápido!'});}
H.loop(dt=>{
 if(over)return;t+=dt;
 ...
 LEAKS.forEach(l=>{
  if(l.hp<=0){x.font='20px system-ui';x.textAlign='center';x.fillText('i:check',l.x,l.y);return;}
  x.font='26px system-ui';x.fillText('i:smoke',l.x+Math.sin(t*6+l.id)*4,l.y);
