#!/usr/bin/env python3
"""Gera games/g255..g256 — Mahjong Solitário e Tarô. Edicao caprichada."""
import os
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
G = os.path.join(ROOT, "games")
GAMES = {}

# 255 — Mahjong Solitário
GAMES[255] = r"""/* NCODE N · 255 Mahjong Solitário — remova os 38 pares! */
GREG(255,{
init(root,H){
...
# 256 — Tarô Interativo
GAMES[256] = r"""/* NCODE N · 256 Tarô Interativo — combine o arcano ao momento! */
GREG(256,{
init(root,H){
